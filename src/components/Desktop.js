...
const Desktop = ({
  ...
  const StartDropDown = () => {
    return (
      <div
        className={`window-option absolute ${startMenu ? "visible" : "invisible"
  ...
  const NotificationModal = () => {
    return (
      <div
        className={`modal absolute ${notification ? "visible" : "invisible"} ${resize
      ...
      <div className="basis-[87%] flex relative">
        ...
        <div className="basis-3/5 grid place-content-center">
          <div className="notification relative">
            <div
              className={`${notification ? "invisible" : "visible"
